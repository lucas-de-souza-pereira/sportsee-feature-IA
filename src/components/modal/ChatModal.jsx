...
import { useDataCoach } from "@/hooks/useUser"
...
export default function ChatModal( {isOpen, onClose}) {
    ...
    ref={dialogRef}
    onClose={onClose}
    className="w-[90%] xl:w-[1200px] h-[900px] min-h-[900px] m-auto mb-0 bg-foreground relative backdrop:opacity-80 rounded-t-sm overflow-hidden"
    closedby="any"
    >
    ...
    <div className="w-[800px] min-h-screen mx-auto flex flex-col">

        <div className="flex-1 flex flex-col gap-10 max-h-[612px] overflow-y-auto">
            ...
            {(message.length > 0) && (
                <div className="w-full mt-19.75 flex flex-col gap-10 m-auto overflow-scroll">
    ...
    <path d="M10.862 5.80239C10.6649 5.99742 10.3449 5.99792 10.1479 5.80239L6.00993 1.70546V15.5C6.00993 15.776 5.7839 16 5.50486 16C5.22583 16 4.99979 15.776 4.99979 15.5V1.70546L0.861834 5.8019C0.66481 5.99742 0.344792 5.99742 0.147768 5.8019C-0.049256 5.60637 -0.049256 5.28984 0.147768 5.09481L5.14781 0.144774C5.34284 -0.0482597 5.66735 -0.0482597 5.86237 0.144774L10.8624 5.09481C11.0595 5.29034 11.0595 5.60687 10.862 5.80239C11.0595 5.60687 10.6649 5.99742 10.862 5.80239Z" fill="white"/>
            ...
            <div className="w-full flex flex-row gap-3.25 mt-6">
                <Proposal onClick={sendMessage}>Comment améliorer mon endurance ?</Proposal>
                <Proposal onClick={sendMessage}>Que signifie mon score de récupération ?</Proposal>
                <Proposal onClick={sendMessage}>Peux-tu m’expliquer mon dernier graphique ?</Proposal>
            </div>
        </div>
    </div>
